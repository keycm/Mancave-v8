...
<head>
    ...
    <style>
        ...
        .testimonial-box { margin-bottom: 30px; background: #f9f9f9; border-radius: 12px; padding: 40px; }
...
<body>
            ...
            <div class="row" style="align-items: stretch;">
                ...
                <div class="col-6">
                    <div style="height: 100%; min-height: 450px; width: 100%; border-radius: var(--radius); overflow: hidden; box-shadow: var(--shadow-soft);">
                        <iframe 
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d123284.2676442322!2d120.47827287966964!3d15.076329599302727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3396f09b763681bd%3A0x486472755033992!2sPorac%2C%20Pampanga!5e0!3m2!1sen!2sph!4v1684426348232!5m2!1sen!2sph" 
                            width="100%" 
                            height="100%" 
                            style="border:0;" 
                            allowfullscreen="" 
    ...
    <div class="modal-overlay" id="reserveModal">
        <div class="modal-card">
            ...
            <form action="submit_booking" method="POST"> <input type="hidden" id="res_art_id" name="artwork_id">
                <div class="form-group">
